...
- (void)didSelectItemAtIndex:(NSUInteger)index withFormat:(NSUInteger)secondIndex withString:(NSString*)string; // * For CustomPickerType
@end
...
@property (strong, nonatomic) NSArray *arrayAMPM;
